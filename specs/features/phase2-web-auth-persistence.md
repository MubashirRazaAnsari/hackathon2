...
As a visitor, I want to create an account with my email and password so that I can have a private space for my tasks.

### US-202: Secure Authentication

As a registered user, I want to log in securely so that only I can access my data.

### US-203: Persistent Task Storage

As a user, I want my tasks to be saved in a database so that they are available whenever I log in from any device.

### US-204: Multi-User Isolation

As a user, I want to be certain that my tasks are private and not visible to any other registered users of the application.

### US-205: Web Dashboard

As a user, I want a clean web dashboard to manage my tasks efficiently through a browser interface.
